...
function getFloatingNavItems(resume) {
    var floating_nav_items = [
        {label: 'Over mij', target: 'about', icon: 'board', requires: 'basics.summary'},
        {label: 'Werk ervaring', target: 'work-experience', icon: 'office', requires: 'work'},
        {label: 'Vaardigheden', target: 'skills', icon: 'tools', requires: 'skills'},
        {label: 'Opleiding', target: 'education', icon: 'graduation-cap', requires: 'education'},
        {label: 'Prijzen', target: 'awards', icon: 'trophy', requires: 'awards'},
        {label: 'Vrijwilligerswerk', target: 'volunteer-work', icon: 'child', requires: 'volunteer'},
        {label: 'Publicaties', target: 'publications', icon: 'newspaper', requires: 'publications'},
        {label: 'Interesses', target: 'interests', icon: 'heart', requires: 'interests'},
        {label: 'Referenties', target: 'references', icon: 'thumbs-up', requires: 'references'}
    ];
